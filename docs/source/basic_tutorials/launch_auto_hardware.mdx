...
environment setup. You can develop fully locally on a Colab or local Python script, while submitting distributed
launching to a remote cluster to take advantage of remote hardware.
...
arguements, and abstracts away the process to launch mutli-GPU processing.
